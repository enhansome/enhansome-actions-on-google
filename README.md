# Awesome Actions on Google with stars
...
* Name Psychic [(Node.js)](https://github.com/actions-on-google/dialogflow-name-psychic-nodejs) ⚠️ Archived [(Java)](https://github.com/actions-on-google/dialogflow-name-psychic-java) ⚠️ Archived - Permissions and Google Maps Static API sample (using Dialogflow).
* Silly Name Maker [(Node.js)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-nodejs) ⚠️ Archived [(Java)](https://github.com/actions-on-google/dialogflow-silly-name-maker-webhook-java) ⚠️ Archived - Parameters sample (using Dialogflow).
* [Canvas Quiz](https://github.com/googlecreativelab/aog-canvas-quiz) ⚠️ Archived - It is a starter kit for developers to make custom, voice-enabled question-answer games for the Google Assistant.
* [Virtual Pet](https://github.com/actions-on-google-labs/virtual-pet-game-nodejs) ⚠️ Archived - It is built with interactive canvas. In this game, you will adopt and take care of a hamster just like you would in real life, except through Google Assistant.
* [Interactive Canvas editor](https://github.com/actions-on-google-labs/interactive-canvas-editor-nodejs) ⚠️ Archived - Editor to create a web app for Interactive Canvas that is immediately loaded onto a smart display device. This allows for quick prototyping of web apps for Interactive Canvas.
* [GDG Action](https://github.com/actions-on-google/dialogflow-gdg-nodejs) ⚠️ Archived - This sample demonstrates Actions on Google features for use on Google Assistant including localization (i18n-node), conversation design, rich responses, and API integrations.
* [karaoke](https://github.com/amdcaruso/karaoke) ⭐ 13 | 🐛 1 | 🌐 HTML | 📅 2019-06-07 - [Amanda Cavallaro](https://github.com/amdcaruso) - Conversational App to buid your own karaoke using GCP, YouTube API and Actions on Google.
* [PDPU Scheduler](https://github.com/nish17/scheduler) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2019-03-24 - It's a Google Assistant action for PDPU that tells you about which classes and labs you have today.
* [Spellcast](https://github.com/actions-on-google-labs/dialogflow-spellcast-nodejs) ⚠️ Archived - Experimental Interactive Canvas game for the Google Assistant.
